    ...
    return (
        <div className="hero">
            <div className="wrapper">
                ...
                <motion.h2 variants={textVariants}>Akash Neekhara</motion.h2>
                <motion.h1 variants={textVariants}>Software Developer</motion.h1>
                <motion.div variants={textVariants} className="buttons">
                    <motion.button variants={textVariants}>See the Latest Works</motion.button>
                    <motion.button style={{color:"black",backgroundColor:"white"}}variants={textVariants}>Contact Me</motion.button>
                </motion.div>
